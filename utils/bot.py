...
async def main():
    ...
    async with ClientSession() as server_client:
     async with ModMail(command_prefix="?", activity=discord.Game("DM for support"), owner_ids=[542798185857286144, 321750582912221184], help_command=None, client=server_client, debug=True, intents=intents, testing_guild_id=884470177176109056, initial_cogs=ext) as bot:
